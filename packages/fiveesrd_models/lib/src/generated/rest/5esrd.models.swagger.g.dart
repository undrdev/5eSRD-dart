...
// Equipment.fromJson() is implemented as a custom factory in the class definition
// that performs type discrimination based on equipment_category.index.
// Equipment.toJson() is abstract and implemented by concrete subclasses (Weapon, Armor, Gear).
...
Map<String, dynamic> _$RaceToJson(Race instance) => <String, dynamic>{
  ...
  'starting_proficiencies': instance.startingProficiencies
      ?.map((e) => e.toJson())
      .toList(),
  'starting_proficiency_options': instance.startingProficiencyOptions?.toJson(),
